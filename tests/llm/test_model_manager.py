...
def test_override_parameters_in_completion(env_vars):
    ...
    with patch.dict(os.environ, {'model': 'openai-gpt35', **env_vars}), \
         patch('src.llm.model_manager.completion') as mock_completion:
